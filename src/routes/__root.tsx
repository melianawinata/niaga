...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NiagaERP" },
      { name: "description", content: "NiagaERP — ERP mini berbasis cloud untuk UMKM dagang Indonesia." },
      { name: "author", content: "NiagaERP" },
      { property: "og:title", content: "NiagaERP" },
      { property: "og:description", content: "NiagaERP — ERP mini berbasis cloud untuk UMKM dagang Indonesia." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@NiagaERP" },
    ],
    links: [
